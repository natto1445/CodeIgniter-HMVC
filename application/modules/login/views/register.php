                  ...
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">ฉันเห็นด้วยและยอมรับ <a href="#">ข้อกำหนดและเงื่อนไข</a></label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">มีบัญชีผู้ใช้งานแล้ว? <a href="<?php echo base_url(); ?>login">เข้าสู่ระบบ</a></p>
                    </div>
                  </form>
