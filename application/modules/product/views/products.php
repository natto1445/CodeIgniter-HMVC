...
<main id="main" class="main">
    ...
    <div class="div" style="margin-bottom: 20px;">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
            data-bs-target="#addproduct">เพิ่มข้อมูล</button>
    </div>
                ...
                <div class="modal-body">
                    <form id="add_product" class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" id="pic_product" name="pic_product" accept="image/*"
                        ...
                        <div class="col-md-6">
                            <label for="barcode_product" class="form-label">barcode สินค้า</label>
                            <input type="text" class="form-control" id="barcode_product" name="barcode_product">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="discount_per" name="discount_per" value='0'
                                step='0.01'>
                        </div>

                        <div class="col-md-6">
                            <label for="discount_bath" class="form-label">ส่วนลดบาท</label>
                            <input type="number" class="form-control" id="discount_bath" name="discount_bath" value='0'
                                step='0.01'>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="detail" name="detail"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit_product" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" id="Epic_product" name="Epic_product" accept="image/*"
                                onchange="Epreviewpic(event)" required>
                        </div>

                        <div class="col-md-6">
                            <div class="col-md-12 d-flex justify-content-center align-items-center">
                                <div id="barcodeContainer">
                                    <img id="previewbarcode" src="<?=$pic?>" alt="barcode Preview"
                        ...
                        <div class="col-md-4">
                            <label for="name_type" class="form-label">ประเภทสินค้า</label>
                            <select class="form-select" id='Ecode_type' name='Ecode_type'
                                aria-label="Default select example">
                                <option value="0">--ระบุประเภทสินค้า--</option>
                                <?php for ($i = 0; $i < count($rec_type); $i++) {?>
                                <option value="<?=$rec_type[$i]['code_type']?>">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="Ediscount_per" name="Ediscount_per"
                                step='0.01'>
                        </div>

                        <div class="col-md-4">
                            <label for="Ediscount_bath" class="form-label">ส่วนลดบาท</label>
                            <input type="number" class="form-control" id="Ediscount_bath" name="Ediscount_bath"
                                step='0.01'>
                        </div>
              ...
              <label for=" inputDate" class="col-md-6 col-form-label">วันที่หมดอายุ</label>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="Edetail" name="Edetail"
                                    style="height: 100px;"></textarea>
