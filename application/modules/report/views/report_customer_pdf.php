...
<page size="A4">
    <div class="div" style='text-align: center; margin-bottom: 10px;'>
        <a style='font-size: 24px; font-weight: bold;'>รายงานการขายรายลูกค้า</a><br>
        <a style='font-size: 20px; font-weight: bold;'>ระหว่างวันที่ <?=$date_start?> - วันที่ <?=$date_end?></a><br>
        <a style='font-size: 20px; font-weight: bold;'>ลูกค้า <?=$customer?></a>
    </div>
    <div class="div">
