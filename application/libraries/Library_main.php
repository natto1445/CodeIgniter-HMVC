...
class Library_main
{
    ...
    public $layout = 'template_main';
    public $pageTitle = '';
    public $link = array();
    public $linksStyleSheet = array();
    public $linksJavascript = array();
    public $linksJavascriptModels = array();
    public $module = null;
    ...
    public function setJavascriptModels($link)
    {
        $this->linksJavascriptModels[] = $link;
        return $this;
    }
    ...
    public function view($v, $data = array())
    {
        ...
        $data['linksJavascriptModels'] = $this->linksJavascriptModels;
